    ...
    private class ButtonListener implements ActionListener
    {
        public void actionPerformed (ActionEvent event)
        {
            ...
            if (event.getSource() == enter)
            {
                ...
                if (lab2 == "Please enter date of the topic/part/test in the format yyyy-mm-dd")
                {
                ...
                if (lab2 == "Please enter a name for the topic/test/part:")
                {
                ...
                if (lab2 == "Please enter the full name of the coordinating supervisor:")
                {
                ...
                if (lab2 == "Is this topic/test/part compulsory?[yes][no]")
                {
                ...
                if (!dat2.matches("") && !top1.matches("") && !sup1.matches("") && !comp1.matches("") && !correct1.matches(""))
                {
                 ...
                 if(inp1.matches("2"))
                {
                 ...
                 if (lab2 == "Please enter date of that the test was conducted: yyyy-mm-dd")
                {
                ...
                if (lab2 == "Please enter the full name of the Topic being marked:")
                {
                ...
                if (!dat2.matches("") && !top1.matches("") && !correct1.matches(""))
                {
